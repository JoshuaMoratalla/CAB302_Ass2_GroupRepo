...
public class testShape extends JFrame {
    ...
    public void paint(Graphics g){
        ...
        drawAPolygon(g2D,new Point (400,100),50,200);


        g2D.draw( new StarPolygon( 6,
                new Point2D.Float(100,200),
                new Point2D.Float(150,250),
                new Point2D.Float(125,225)));
